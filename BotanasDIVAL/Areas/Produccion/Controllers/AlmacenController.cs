...
namespace BotanasDIVAL.Controllers
{
    public class AlmacenController : Controller
    {
        ...
        public AlmacenController(DbDivalContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdIngrediente,Cantidad,FechaCaducidad,Status,Observaciones")] Almacen almacen)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Details", new { id = almacen.IdAlmacen });
            }
